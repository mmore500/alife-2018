...
We seeded the grid with three copies of each of three champion genotypes from evolutionary trials (see Figure \ref{fig:genotypes}).
Then, with mutation disabled to prevent further evolution, the genotypes competed for 1.5 million updates.
