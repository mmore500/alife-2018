...
Every 50,000 updates following update 500,000, we randomly selected Level 2 channel IDs and killed all cells with that channel ID until at least 5\% of grid tiles were empty.
We performed 50 replications of this experiment.
...
Under control conditions, same-channel signaling networks just help cells recognize other related cells.
In our implementation, this corresponded to resource waves with a radius 1 (i.e., the resource wave did not expand beyond its seed), a value of 1.0 resource, and zero erroneous activation cost.
All lifestyle parameters functioned identically to standard conditions.
We seeded each tile on the $120 \times 120$ toroidal grid with a randomized organism, ran the simulation for 20 million updates, and performed culls identically to the standard experimental conditions.
We performed 50 replications of this experiment.
...
We observed a spectrum of evolved resource-caching strategies.
