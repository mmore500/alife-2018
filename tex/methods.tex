...
Unfortunately, efforts to prepare the system for an operating system upgrade caused intermittent disk unavailability and checkpoint-restart failure.
...
Due to checkpoint-restart failures, we curtailed our standard-condition evolutionary runs from a planned 25 million to 20 million updates and our control evolutionary runs to 250,000 updates.
...
Each replicate of control evolutionary experiments expended on the order of one day of compute time to reach 250,000 updates.
